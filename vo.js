...
(() => {
  ...
  const dict = {
    fr: {
      ...
      'srv.title': "Le prix est dit <em>avant</em> de commencer",
      'srv.sub': "Pas de supplément découvert à la fin. Le devis part sur WhatsApp avec la proposition de créneau.",
      'srv.from': 'dès', 'srv.popular': 'Le plus demandé', 'srv.perNail': '/ ongle',
      'srv.1.t': 'Pose gel',
      'srv.1.d': "Préparation complète, base renforcée, couleur au choix, finition brillante ou mate. 1 h 15.",
      'srv.2.t': 'Gel-X & capsules',
      'srv.2.d': "Extension souple, sans limage agressif de l'ongle naturel. Forme et longueur sur mesure. 1 h 45.",
      'srv.3.t': 'Acrylique complète',
      'srv.3.d': "Structure solide pour les mains qui travaillent. Tenue maximale, rendu net jusqu'au remplissage. 2 h.",
      'srv.4.t': 'Nail art',
      'srv.4.d': "Dessin main levée, chrome, encapsulé, cristaux. Le devis dépend du motif, jamais de l'humeur.",
      'srv.5.t': 'Remplissage',
      'srv.5.d': "Toutes les trois à quatre semaines. Repousse rattrapée, structure rééquilibrée, couleur refaite. 1 h 30.",
      'srv.6.t': 'Dépose & soin',
      'srv.6.d': "Retrait en douceur, ongle nettoyé, cuticules soignées, huile nourrissante. Offert si vous enchaînez sur une pose.",
      'srv.note': "Tarifs indicatifs, confirmés sur WhatsApp avant le rendez-vous. Paiement sur place.",
    ...
    en: {
      ...
      'srv.title': 'You hear the price <em>before</em> we start',
      'srv.sub': "No surprise line at the end. The quote goes out on WhatsApp together with the proposed slot.",
      'srv.from': 'from', 'srv.popular': 'Most requested', 'srv.perNail': '/ nail',
      'srv.1.t': 'Gel set',
      'srv.1.d': "Full prep, reinforced base, colour of your choice, gloss or matte finish. 1 h 15.",
      'srv.2.t': 'Gel-X & tips',
      'srv.2.d': "Flexible extension with no aggressive filing of the natural nail. Shape and length made to measure. 1 h 45.",
      'srv.3.t': 'Full acrylic',
      'srv.3.d': "Solid structure for hands that work. Maximum wear, still sharp by the time the fill comes round. 2 h.",
      'srv.4.t': 'Nail art',
      'srv.4.d': "Freehand painting, chrome, encapsulated, crystals. The quote follows the design, never the mood.",
      'srv.5.t': 'Fill',
      'srv.5.d': "Every three to four weeks. Regrowth caught up, structure rebalanced, colour redone. 1 h 30.",
      'srv.6.t': 'Removal & care',
      'srv.6.d': "Gentle soak-off, nail cleaned, cuticles tended, nourishing oil. Free when a new set follows on the same visit.",
      'srv.note': "Indicative pricing, confirmed on WhatsApp before your appointment. Payment on site.",
