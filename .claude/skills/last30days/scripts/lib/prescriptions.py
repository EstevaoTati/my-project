...
# Resolved from this file's location so the printed command is copy-pasteable
# from any install layout (flat skill dir, plugin cache, repo checkout).
ENGINE_CLI = f"python3 {Path(__file__).resolve().parents[1] / 'last30days.py'}"
